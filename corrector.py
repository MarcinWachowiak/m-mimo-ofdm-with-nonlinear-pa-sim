...
class CncReceiver():
    ...
    def receive(self, n_iters: int, upsample_factor: int, in_sig_fd, channel_estimation_mat=None):
        ...
        if channel_estimation_mat is not None:
            rx_ofdm_nsc_fd = rx_ofdm_nsc_fd / channel_estimation_mat
        #print("Rx corr", signal_power(rx_ofdm_nsc_fd))
