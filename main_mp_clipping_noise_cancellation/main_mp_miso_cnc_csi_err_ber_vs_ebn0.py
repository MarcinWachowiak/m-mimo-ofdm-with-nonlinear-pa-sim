    ...
    for n_ant_val in n_ant_arr:
        ...
        for my_miso_chan in chan_lst:
            ...
            mp_link_obj = mp_model.Link(mod_obj=my_mod, array_obj=my_array, std_rx_obj=my_standard_rx,
                                        ...
                                        bits_sent_max=bits_sent_max, is_mcnc=False, csi_noise_db=csi_noise_db)
            ...
            for ibo_val_db in ibo_arr:
                ...
                for ebn0_step_val in ebn0_step:
                    ...
                    filename_str = "ber_vs_ebn0_cnc_%s_csi_noise_db%d_nant%d_ibo%d_ebn0_min%d_max%d_step%1.2f_niter%s" % (
                        my_miso_chan, csi_noise_db, n_ant_val, ibo_val_db, min(ebn0_arr), max(ebn0_arr),
