...
data_lst_cnc = utilities.read_from_csv(
    filename="fixed_ber1.0e-02_cnc_two_path_nant1_ebn0_min10_max30_step2.00_ibo_min0_max7_step1.00_niter1_2_3_5_8")
ibo_arr_cnc = data_lst_cnc[0]
req_ebn0_per_ibo_cnc = data_lst_cnc[1:]

data_lst_mcnc = utilities.read_from_csv(
    filename="fixed_ber1.0e-02_mcnc_two_path_nant1_ebn0_min10_max30_step2.00_ibo_min0_max7_step1.00_niter1_2_3_5_8")
