...
and third order memory-less polynomial model of nonlinear distortion.
"""
    ...
    for n_ant_val in n_ant_arr:
        ...
        for my_miso_chan in chan_lst:
            ...
            for dist_val_db in dist_val_arr:
                ...
                my_cnc_rx.update_distortion(ibo_db=dist_val_db, alpha_val=alpha_estimate)
                ...
                for ebn0_step_val in ebn0_step:
                    ...
                    filename_str = "toi_ber_vs_ebn0_cnc_%s_nant%d_ibo%d_ebn0_min%d_max%d_step%1.2f_niter%s" % (
