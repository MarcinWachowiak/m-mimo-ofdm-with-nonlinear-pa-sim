...
#%%
# TODO: formalize naming of the CSV and plot files
# TODO: add sim launcher loop
# TODO: cleanup upsampling references and code
data_lst = []
data_lst.append(ebn0_arr)
for arr1 in ber_per_dist:
    data_lst.append(arr1)
utilities.save_to_csv(data_lst=data_lst, filename="cnc_%s_nant%d_ber_ibo%d_niter%d_sweep.csv" % (my_miso_chan, n_ant, ibo_val_db, np.max(cnc_n_iters_lst)), )
