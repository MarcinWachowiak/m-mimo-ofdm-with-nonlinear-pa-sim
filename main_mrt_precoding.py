...
my_array = antenna_arrray.LinearArray(n_elements=8, transceiver=my_tx, center_freq=3.5e9, wav_len_spacing=0.5)
my_rx = transceiver.Transceiver(modem=my_mod,  impairment=None, cord_x=10, cord_y=10)
