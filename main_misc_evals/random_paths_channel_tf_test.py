"""
Plot the random paths channel model frequency response.
"""
...
if __name__ == '__main__':
    ...
    # %%
    # plot the random path channel frequency response
    ...
    ax1.set_title("Random paths channel model")
    ax1.set_ylabel("Frequency response |h(f)| [dB]")
    ax1.set_xlabel("Subcarrier index [-]")
    ax1.grid()
    ax1.legend(title="TX-RX idx:")
    plt.tight_layout()
    plt.savefig(
        "../figs/random_paths_channel_fr_npaths%d_maxdelayspr%1.2e.png" % (
