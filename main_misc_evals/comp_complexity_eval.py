"""
Calculate the total number of arithmetic operations: additions/subtractions, multiplications/divisions
of the CNCN and MCNC algorithm according to the complexity analysis presented in the article.
"""
