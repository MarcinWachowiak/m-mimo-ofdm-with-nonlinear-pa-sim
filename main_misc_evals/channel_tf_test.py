"""
Plot the channel transfer function and the precoding coefficients, phase and magnitude separately.
"""
...
if __name__ == '__main__':
    ...
    freq_bin_nsc = np.concatenate((freq_bin_vec[-(my_mod.n_sub_carr // 2):], freq_bin_vec[1:(my_mod.n_sub_carr // 2) + 1]),
                                  axis=0)
