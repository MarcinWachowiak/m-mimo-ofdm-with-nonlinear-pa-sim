...
tx_bits = np.repeat([0], my_mod.n_bits_per_ofdm_sym)
...
phase_after_precod = np.concatenate(
    (phase_after_precod[-(my_mod.n_sub_carr // 2):], phase_after_precod[1:(my_mod.n_sub_carr // 2) + 1]), axis=0)
phase_after_nl = np.concatenate(
    (phase_after_nl[-(my_mod.n_sub_carr // 2):], phase_after_nl[1:(my_mod.n_sub_carr // 2) + 1]), axis=0)
