...
my_limiter1 = impairments.SoftLimiter(-3, my_mod.avg_symbol_power)
my_limiter2 = impairments.Rapp(-3, my_mod.avg_symbol_power, 5)
my_distortion = impairments.ThirdOrderNonLin(15, my_mod.avg_symbol_power)
