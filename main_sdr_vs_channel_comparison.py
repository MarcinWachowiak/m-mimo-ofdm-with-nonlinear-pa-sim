...
ax1.grid(True)
ax1.set_title("a) Kanał LOS", fontsize=8)
...
ax2.grid(True)
ax2.set_title("b) Kanał dwuścieżkowy", fontsize=8)
...
ax3.grid(True)
ax3.set_title("c) Kanał Rayleigha", fontsize=8)
ax3.legend(title="Liczba anten:", ncol=len(n_ant_vec), loc=(0.05, -0.6), borderaxespad=0)
ax3.set_xlabel("Kąt [°]", fontsize=8)
ax3.set_ylabel("SDR [dB]", fontsize=8)
ax3.set_xlim([0, 180])
ax3.set_ylim([24,50])
ax3.set_yticks([26, 32, 38, 44, 50])
ax3.set_xticks(np.linspace(0, 180, 7, endpoint=True))
fig.suptitle("Stosunek mocy sygnału pożądanego do zniekształcenia")
