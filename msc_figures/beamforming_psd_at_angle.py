...
ax1.set_title("Power spectral density of transmitted OFDM signal at angle of 45$\degree$")
...
ax1.set_title("Power spectral density of transmitted OFDM signal at angle of 78$\degree$")
ax1.set_xlabel("Subcarrier index [-]")
ax1.set_ylabel("Power spectral density [dB]")
ax1.legend(title="Signals:")
ax1.grid()
